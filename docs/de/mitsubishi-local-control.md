...
| rssi        | string  | WLAN-Signalstärke                                    |
| app_version | string  | Firmware- / Applikationsversion                      |
| online      | boolean | Gibt an, ob das Gerät erreichbar ist                 |
| hasError    | boolean | Gibt an, ob sich das Gerät im Fehlerzustand befindet |
